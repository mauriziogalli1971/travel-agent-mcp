/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 02a579b0a6186d8844a869e24e83aa17)
// Runtime types generated with workerd@1.20260212.0 2025-09-06 nodejs_compat
declare namespace Cloudflare {
  ...
  interface ProductionEnv {
    ...
    MCP_SERVER_URL: string;
    CF_AI_GATEWAY: string;
    MCP_SERVER: Fetcher /* mcp-server-production */;
  }
  interface Env {
    OPENAI_API_KEY: string;
    MCP_SERVER_URL: string;
...
declare namespace NodeJS {
  interface ProcessEnv extends StringifyValues<
    Pick<Cloudflare.Env, 'CLOUDFLARE_INCLUDE_PROCESS_ENV' | 'OPENAI_API_KEY' | 'MCP_SERVER_URL' | 'CF_AI_GATEWAY'>
  > {}
}
...
type ConversionOptions = {
  html?: { images?: EmbeddedImageConversionOptions & { convertOGImage?: boolean }; hostname?: string };
